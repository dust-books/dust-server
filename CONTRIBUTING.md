...
[Dust Code of Conduct](https://www.github.com/dust-books/dust-serverblob/master/CODE_OF_CONDUCT.md).
...
Before you ask a question, it is best to search for existing [Issues](https://www.github.com/dust-books/dust-server/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://www.github.com/dust-books/dust-server/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://www.github.com/dust-books/dust-serverissues?q=label%3Abug).
...
- Perform a [search](https://www.github.com/dust-books/dust-server/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
